...
<body class="hold-transition register-page">
    <div class="register-box">
        <div class="register-logo">
            <a href="<?= base_url() ?>/assets/index2.html"><b>Register Pemuda </b></a>
        </div>

        <div class="card">
            <img src="assets/dist/img/login.png" class="img-circle btn-sm-2 " alt="Cinque Terre">
